...
function getdata(el,cont){
    ...
    p3.innerText= "₹"+Math.floor(el.price)
...
function append(data){
    ...
    data.forEach((el,index)=>{
         ...
         let dis_price=Math.floor(el.price)
         h32.innerText= "₹"+ (dis_price)
         div2.append(h31,h32)
         let div3=document.createElement("div")
         div3.setAttribute("id","thirddiv")
         ...
         div4.setAttribute("id","fourthdiv")
         div4.innerHTML=`<p id="pricepara"> MRP <span id="pricespan">₹${el.price}</span></p>`
